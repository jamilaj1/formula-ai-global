...
(function () {
  ...
  const HAZARD_RULES = [
    ...
    { match: /\bethanol\b|isopropyl alcohol|\bIPA\b/i, level: "caution", note: "Highly flammable · keep away from heat" },
    ...
    { match: /sulfonic acid|sulphonic acid|labsa|alkylbenzene sulf|dodecylbenzene sulf/i, level: "warning", note: "Strong organic acid · very low pH · skin/eye corrosive in raw form · must be neutralized before use" },
