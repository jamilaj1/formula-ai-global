...
from app.api.v2 import compliance, subscription, ads, global_initiatives, consulting, library_pdf, chat_export
...
app.include_router(consulting.router, prefix="/api/v2")
